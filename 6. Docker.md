...
install `Container Tools` extension from the extensions. then go to containers tab and right click the container and choose `attach visual studio code`.

<img src="./resources/code_container.png" alt="open vs code" style="width:400px;"/>
